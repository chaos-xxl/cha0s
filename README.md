...
> 把 Doctor Chaos 集成到我当前的项目里。读 https://github.com/doctorchaos-ai/doctor-chaos/blob/main/LLMS.md 这份集成说明,按里面的步骤修改我的代码。我用的 LLM 是:**[这里填 DeepSeek / Claude / OpenAI / Kimi / Qwen / MiniMax / 豆包 / 智谱 之一]**。

AI 会自己读完 [LLMS.md](./LLMS.md),识别你的项目类型(OpenClaw / Koishi / Telegram bot / 自建 agent 等),装对应的 npm 包,改对你代码里需要改的那两处。
...
> Integrate Doctor Chaos into my current project. Read https://github.com/doctorchaos-ai/doctor-chaos/blob/main/LLMS.md and follow its integration procedure to modify my code. My LLM provider is: **[OpenAI / Claude / DeepSeek / Kimi / Qwen / MiniMax / Doubao / Zhipu]**.

The AI reads [LLMS.md](./LLMS.md), detects your project type (OpenClaw / Koishi / Telegram bot / custom agent), installs the right packages, and wires them into your message handler. You write no code — you only approve the AI's diff.
